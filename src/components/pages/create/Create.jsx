            ...
            <div className="md:ml-64 h-full overflow-y-auto relative pb-20 md:pb-6 scrollbar-hide md:scrollbar-custom">
                ...
                <div className="flex items-start justify-center px-3 md:px-6 py-4 md:py-12 pb-24 md:pb-12">
                    ...
                    <div className="text-center mb-4 md:mb-10">
                        <h1 className="text-2xl md:text-4xl font-bold mb-1 md:mb-3 bg-gradient-to-r from-orange-400 to-orange-500 bg-clip-text text-transparent">
                    ...
                    <div className="bg-white/5 backdrop-blur-lg border border-white/10 rounded-2xl p-4 md:p-8 shadow-2xl"
