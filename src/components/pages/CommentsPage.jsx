...
function CommentsPage() {
    ...
    return (
      <div className="page-container">
        <div className="text-center flex flex-col items-center gap-4">
          <LoadingDots size={12} />
          <h2 className="text-xl font-bold">Loading Comments...</h2>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="page-container flex flex-col gap-2 h-full">
      <button
        onClick={() => navigate(-1)}
        className="flex items-center space-x-2 px-1 py-2 rounded-lg font-bold transition-colors hover:bg-accent hover:cursor-pointer w-fit"
      >
      ...
      {/* comment form */}
      <div className="rounded-lg p-2 md:p-6 border">
