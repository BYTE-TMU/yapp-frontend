...
import { Search, User, UserPlus, Users as UsersIcon, Sparkles } from 'lucide-react';
...
function Users() {
  ...
  const fetchRecommendations = useCallback(async () => {
    if (!isLoggedIn()) { setRecLoading(false); return; }
    try {
      setRecLoading(true);
  ...
  return (
    <div className="min-h-screen font-bold w-screen" style={{ fontFamily: 'Albert Sans' }}>
      <Header />
      <Sidebar />
      <div className="md:ml-64 p-6">
        {/* Animated background blobs */}
        <div className="fixed inset-0 md:ml-64 overflow-hidden pointer-events-none">
          <div className="absolute -top-40 -right-40 w-96 h-96 bg-linear-to-br from-primary/20 to-orange-400/20 rounded-full blur-3xl animate-pulse" />
          <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-linear-to-tr from-orange-600/20 to-orange-300/20 rounded-full blur-3xl animate-pulse delay-1000" />
        </div>
          ...
          <div className="mb-8">
            <div className="relative">
              ...
              <input
                ...
                autoComplete="off"
                className={`w-full pl-10 pr-4 py-3 border rounded-lg focus:outline-none transition-colors ${isDarkMode
          ...
          {showRecommendations && (
            <div className="mb-10">
              ...
              <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className={`text-lg font-bold ${isDarkMode ? 'text-gray-300' : 'text-white-900'}`}>
                  ...
                  {[...Array(4)].map((_, i) => (
                    ...
                    >
                      <div className="flex flex-col items-center gap-3">
                        <div className="w-14 h-14 rounded-full" style={{ backgroundColor: skeletonEl }} />
                        <div className="h-3 w-24 rounded" style={{ backgroundColor: skeletonEl }} />
                        <div className="h-3 w-16 rounded" style={{ backgroundColor: skeletonBg }} />
                        <div className="h-8 w-full rounded-lg" style={{ backgroundColor: skeletonBg }} />
                      </div>
                    </div>
                  ))}
                </div>
                    ...
                    return (
                      ...
                      >
                        <div className="flex flex-col items-center text-center gap-2">
                          ...
                          <div>
                            {rec.full_name && (
                              <p className={`text-sm font-bold truncate max-w-[140px] ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
                                {rec.full_name}
                              </p>
                            )}
                          ...
                          {rec.mutual_count > 0 && (
                            <span
                              ...
                              style={{
                                backgroundColor: isDarkMode ? 'rgba(251,146,60,0.15)' : 'rgba(251,146,60,0.12)',
                                color: '#f97316',
                              }}
                            >
                              {rec.mutual_count} mutual {rec.mutual_count === 1 ? 'connection' : 'connections'}
                            </span>
                          )}
                          ...
                          <button
                            ...
                            className={`mt-1 w-full flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg text-sm font-bold transition-all duration-200 ${isFollowing
                              ? isDarkMode
                ...
                {[...Array(3)].map((_, index) => (
                  ...
                  >
                    <div className="flex items-center space-x-4">
                      <div className="w-12 h-12 rounded-full" style={{ backgroundColor: skeletonEl }} />
                      <div className="flex-1">
                        <div className="h-4 rounded w-32 mb-2" style={{ backgroundColor: skeletonEl }} />
                        <div className="h-3 rounded w-48 mb-1" style={{ backgroundColor: skeletonBg }} />
                        <div className="h-3 rounded w-24" style={{ backgroundColor: skeletonBg }} />
                      </div>
                      <div className="w-24 h-8 rounded" style={{ backgroundColor: skeletonEl }} />
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div className="space-y-3">
                {users.map((user) => (
                  <div
                    ...
                    className={`rounded-lg p-4 cursor-pointer transition-all duration-200 ${isDarkMode ? 'hover:bg-zinc-800' : 'hover:bg-gray-50 border border-gray-200'
                      }`}
                    style={{ backgroundColor: cardBg }}
                  >
                    <div className="flex items-center space-x-4">
