...
const LandingPage = () => {
  ...
  const platformFeatures = [
    {
      ...
      description:
        'Chat with friends, create group conversations, and stay connected with your campus community.',
    },
    {
      icon: <Heart className="w-6 h-6" />,
      title: 'Like & Share',
      description:
        'Show appreciation for posts, events, and share interesting content with your network.',
    },
    {
      icon: <Search className="w-6 h-6" />,
      title: 'Smart Search',
      description:
        'Find people, events, and content quickly with our intelligent search and filtering system.',
    },
    {
      icon: <Bell className="w-6 h-6" />,
      title: 'Smart Notifications',
      description:
        'Get personalized notifications about events, messages, and activities that matter to you.',
    },
    {
    ...
    },
    {
      ...
      description:
        'Connect with students across your entire university campus, not just your department.',
    },
  ];
  ...
  return (
    <div
      ...
      style={{ backgroundColor: '#121212', fontFamily: 'Albert Sans' }}
    >
      {/* Animated Background */}
      <div className="absolute inset-0">
        ...
        <div
          className="absolute -bottom-40 -left-40 w-96 h-96 bg-gradient-to-tr from-orange-600/20 to-orange-300/20 rounded-full blur-3xl animate-pulse delay-1000 animate-float"
          style={{ animationDelay: '2s' }}
        ></div>
        <div
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-r from-purple-500/10 to-blue-500/10 rounded-full blur-3xl animate-pulse delay-500 animate-float"
      ...
      <section className="relative z-10 px-4 sm:px-8 py-12 sm:py-20 text-center">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-6">
            ...
            <br />
            <span
              className="bg-gradient-to-r from-orange-400 to-orange-500 bg-clip-text text-transparent animate-gradient animate-float"
            ...
            <br />
            <span
              className="bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent animate-float"
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-400 mb-8 max-w-3xl mx-auto px-4">
            ...
            exclusively for TMU students. Connect with your community, discover
            amazing events across downtown Toronto, and explore your urban
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-gradient-to-r from-orange-500/10 to-purple-500/10 backdrop-blur-lg border border-white/10 rounded-3xl p-12">
            ...
            <p className="text-gray-400 text-lg mb-8">
              ...
              discovering, and exploring with Yapp.
            </p>
