            ...
            <div className="bg-gradient-to-br from-green-500/20 to-blue-500/20 border border-green-500 rounded-xl p-10 shadow-2xl">
              ...
              <div className="mb-8">
                ...
                <p className="text-gray-400 mb-6">
                  We appreciate you taking the time to help us improve Yapp.
              ...
              <div className="space-y-4">
                <button
                  ...
                  className="bg-linear-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white px-8 py-3 rounded-lg transition-all duration-300 transform hover:scale-105 flex items-center justify-center mx-auto space-x-2 shadow-lg"
                >
