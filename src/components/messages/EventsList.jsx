            ...
            <div className="flex-1 overflow-y-auto pb-20 md:pb-0" style={{
                ...
                {events.map((event) => (
                    <div
                        ...
                        className={`p-4 cursor-pointer transition-colors border-b ${isDarkMode
                    ...
                    >
                        <div className="flex items-start space-x-3">
                            {/* Event Icon */}
                            <div className={`flex-shrink-0 w-12 h-12 rounded-lg flex items-center justify-center ${isDarkMode ? 'bg-orange-500/20' : 'bg-orange-100'
                                }`}>
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <div className="flex items-center mt-1 space-x-3">
                                    ...
                                    <div className={`flex items-center text-xs ${isDarkMode ? 'text-orange-400' : 'text-orange-500'
                                        }`}>
